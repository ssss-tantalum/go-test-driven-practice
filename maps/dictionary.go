...
const (
	...
	// ErrWordExists means your aur trying to add a word that is already known
	ErrWordExists = DictionaryErr("cannot add word because it already exists")

	// ErrWordDoesNotExist occurs when trying to update a word not in the dictionary
	ErrWordDoesNotExist = DictionaryErr("cannot update word because id does not exist")
)

// DictionaryErr aer errors that can happen when interactiong with the dictionary.
...
// Add inserts a wird and definition into the dictionary.
